...
def test_compare_and_cache_default(diff_cache):
    ...
    new_diff = {
        "file1.txt": "new_content1",
        "file2.txt": "old_content2",
...
def test_nested_diffs(diff_cache):
    ...
    new_diff = {
        "file1.txt": {"key1": "new_value1", "key2": "value2", "key3": "value3"},
        "file2.txt": "content2",
    }
...
async def test_performance_with_recursive_diff():
    ...
    try:
        ...
        big_diff2 = {
            "file1.txt": {
                "section1": {"key1": "value1", "key2": "new_value"},
                "section2": "unchanged",
            },
...
async def test_cleanup_task():
    ...
    cache = DiffCache(expiry_duration=short_expiry, cleanup_interval=cleanup_interval)
