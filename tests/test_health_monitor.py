...
class TestHealthStatusGeneration:
    ...
    @pytest.mark.asyncio
    async def test_get_health_status_healthy(self, mock_connections, mock_memory, mock_cpu, health_monitor):
    ...
    @patch("psutil.net_connections")
    @pytest.mark.asyncio
    async def test_get_health_status_warning(self, mock_connections, mock_memory, mock_cpu, health_monitor):
    ...
    @patch("psutil.net_connections")
    @pytest.mark.asyncio
    async def test_get_health_status_critical(self, mock_connections, mock_memory, mock_cpu, health_monitor):
...
class TestBackgroundTasks:
    ...
    async def test_metrics_cleanup_removes_old_data(self, health_monitor):
        ...
        while (
            health_monitor.system_metrics_history and health_monitor.system_metrics_history[0].timestamp < cutoff_time
        ):
