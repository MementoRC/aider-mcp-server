...
class TestCacheManager:
    ...
    def mock_diff_cache(self):
        ...
        mock_cache.get_stats = MagicMock(
            return_value={
                "hits": 5,
                "misses": 3,
                "total_accesses": 8,
    ...
    async def test_process_diff_cache_disabled(self, cache_manager):
        ...
        result_diff, is_cached = await cache_manager.process_diff_cache(cache_key, raw_diff, use_diff_cache=False)
    ...
    async def test_process_diff_cache_not_initialized(self, cache_manager):
        ...
        result_diff, is_cached = await cache_manager.process_diff_cache(cache_key, raw_diff, use_diff_cache=True)
    ...
    async def test_full_workflow(self, cache_manager, mock_diff_cache):
        ...
        with patch("aider_mcp_server.molecules.tools.aider.cache_management.DiffCache", return_value=mock_diff_cache):
            ...
            result_diff, is_cached = await cache_manager.process_diff_cache(key, raw_diff, use_diff_cache=True)
