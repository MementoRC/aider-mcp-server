...
class TestResponseFormatter:
    ...
    def test_process_coder_results_basic(self):
        ...
        with pytest.MonkeyPatch().context() as m:
            ...
            m.setattr(
                "aider_mcp_server.molecules.tools.aider.response_formatting.get_file_status_summary", mock_file_status
            )

            result = formatter.process_coder_results(
                coder_exit_code=0, diff_output="test diff content", working_directory="/test/dir", include_diff=True
            )
    ...
    def test_handle_diff_cache_processing_no_cache(self):
        ...
        final_diff, is_cached = formatter.handle_diff_cache_processing(diff_output, None, "/test/dir")
    ...
    def test_handle_diff_cache_processing_with_cache(self):
        ...
        final_diff, is_cached = formatter.handle_diff_cache_processing(diff_output, mock_cache, "/test/dir")
    ...
    def test_estimate_complexity(self):
        ...
        # Simple complexity
        summary = {"files": ["file1.py"], "stats": {"lines_added": 5, "lines_removed": 3}}
        complexity = formatter.estimate_complexity(summary)
        assert complexity == "simple"

        # Moderate complexity
        summary = {"files": ["file1.py", "file2.py", "file3.py"], "stats": {"lines_added": 30, "lines_removed": 20}}
        complexity = formatter.estimate_complexity(summary)
    ...
    def test_cleanup_file_status_in_response(self):
        ...
        response = {
            "success": True,
            "changes_summary": {},
            "file_status": {"files": [], "stats": {"lines_added": 0, "lines_removed": 0, "files_modified": 1}},
            "rate_limit_info": {},
            "is_cached_diff": False,
            "diff": "",
            "api_key_status": {},
    ...
    def test_get_rate_limit_encountered(self):
        ...
        response = {"rate_limit_info": {"encountered": False}}
    ...
    def test_get_fallback_used(self):
        ...
        response = {"rate_limit_info": {"fallback_model": "gpt-3.5-turbo"}}
        assert formatter.get_fallback_used(response) is True

        # Test without fallback
        response = {"rate_limit_info": {"fallback_model": None}}
