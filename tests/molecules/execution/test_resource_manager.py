...
class TestResource:
    ...
    def test_resource_to_dict(self):
        ...
        resource = Resource("test", ResourceType.FILE, {"data": "test"}, metadata={"category": "temp"})
        resource.access()
...
class TestResourceConstraints:
    ...
    def test_constraints_creation(self):
        ...
        constraints = ResourceConstraints(
            max_resources=10, max_memory_mb=100.0, max_idle_time=300.0, max_age=3600.0, max_access_count=1000
        )
...
class TestResourceManager:
    ...
    def test_resource_allocation_with_allocator(self):
        ...
        resource_obj = manager.allocate_resource(
            resource_id="allocated_resource", resource_type=ResourceType.MEMORY, data="allocator_test"
        )
    ...
    def test_resource_constraints_enforcement(self):
        ...
        resource1 = manager.allocate_resource(
            resource_id="res1", resource_type=ResourceType.MEMORY, factory_func=lambda: {"id": 1}
        )
        resource2 = manager.allocate_resource(
            resource_id="res2", resource_type=ResourceType.MEMORY, factory_func=lambda: {"id": 2}
        )
        ...
        resource3 = manager.allocate_resource(
            resource_id="res3", resource_type=ResourceType.MEMORY, factory_func=lambda: {"id": 3}
        )
    ...
    def test_mark_resource_idle(self):
        ...
        manager.allocate_resource(
            resource_id="idle_test", resource_type=ResourceType.MEMORY, factory_func=lambda: {"data": "test"}
        )
    ...
    def test_cleanup_callbacks(self):
        ...
        manager.allocate_resource(
            resource_id="callback_resource", resource_type=ResourceType.MEMORY, factory_func=lambda: {"data": "test"}
        )
    ...
    def test_resource_statistics(self):
        ...
        manager.allocate_resource(
            resource_id="mem1", resource_type=ResourceType.MEMORY, factory_func=lambda: {"type": "memory"}
        )
        manager.allocate_resource(
            resource_id="file1", resource_type=ResourceType.FILE, factory_func=lambda: {"type": "file"}
        )
        manager.allocate_resource(
            resource_id="mem2", resource_type=ResourceType.MEMORY, factory_func=lambda: {"type": "memory"}
        )
...
class TestGlobalResourceManagement:
    ...
    async def test_cleanup_all_managers(self):
        ...
        manager1.allocate_resource(
            resource_id="res1", resource_type=ResourceType.MEMORY, factory_func=lambda: {"data": "test1"}
        )
        manager2.allocate_resource(
            resource_id="res2", resource_type=ResourceType.MEMORY, factory_func=lambda: {"data": "test2"}
        )
