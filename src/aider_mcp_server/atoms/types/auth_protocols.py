"""Authentication protocols for the Aider MCP Server.

This module contains basic authentication protocols and data types that define
the authentication interface for all authentication implementations in the system.

This was moved from interfaces/authentication_provider.py as part of the
