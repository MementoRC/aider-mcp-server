...
This module contains security service protocols that define the interface
for all security implementations at the molecule level.

This was moved from interfaces/security_service.py as part of the
