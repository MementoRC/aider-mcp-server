...
class ServiceLocator:
    ...
    def register_singleton(
        ...
        self._register_service(
            ...
            ServiceLifecycle.SINGLETON, tags=tags
        )
    ...
    def register_transient(
        ...
        self._register_service(
            ...
            ServiceLifecycle.TRANSIENT, tags=tags
        )
    ...
    def register_scoped(
        ...
        self._register_service(
            service_type, implementation_type, factory, None,
            ServiceLifecycle.SCOPED, scope_id=scope_id, tags=tags
        )
    ...
    def register_lazy_singleton(
        ...
        self._register_service(
            service_type, implementation_type, factory, None,
            ServiceLifecycle.LAZY_SINGLETON, tags=tags
        )
    ...
    def register_weak_singleton(
        ...
        self._register_service(
            service_type, implementation_type, factory, None,
            ServiceLifecycle.WEAK_SINGLETON, tags=tags
        )
    ...
    def get_service_summary(self) -> Dict[str, Any]:
        ...
        for registration in self._registrations.values():
            ...
            if lifecycle_name not in summary['lifecycle_counts']:
                summary['lifecycle_counts'][lifecycle_name] = 0
                summary['services_by_lifecycle'][lifecycle_name] = []
            
            summary['lifecycle_counts'][lifecycle_name] += 1
            summary['services_by_lifecycle'][lifecycle_name].append(
