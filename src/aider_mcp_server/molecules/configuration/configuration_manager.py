...
from typing import Dict, Any, List, Optional, Union, Callable, Set, TypeVar
...
class ConfigurationManager:
    ...
    def _load_defaults(self) -> None:
        ...
        for key, value in defaults.items():
            self._set_entry(
                key, value, ConfigurationSource.DEFAULT,
    ...
    def load_from_environment(self, prefix: str = "AIDER_MCP_") -> None:
        ...
        for key, value in os.environ.items():
            if key.startswith(prefix):
                ...
                self._set_entry(
                    config_key, value, ConfigurationSource.ENVIRONMENT,
                    source_path=f"env:{key}",
                    priority=100
                )
                loaded_count += 1
    ...
    def load_from_file(
        ...
        for key, value in flattened.items():
            self._set_entry(
                key, value, ConfigurationSource.FILE,
    ...
    def _load_environment_specific_file(
        self, base_path: Path, format_type: ConfigurationFormat
    ) -> None:
    ...
    def _load_file_content(self, file_path: Path, format_type: ConfigurationFormat) -> Dict[str, Any]:
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            elif format_type == ConfigurationFormat.TOML:
                try:
                    import tomllib
                    ...
                    try:
                        ...
                        raise ImportError("tomllib or toml is required for TOML configuration files")
    ...
    def set(self, key: str, value: Any, priority: int = 1000) -> None:
        ...
        self._set_entry(
            key, value, ConfigurationSource.OVERRIDE,
            priority=priority,
