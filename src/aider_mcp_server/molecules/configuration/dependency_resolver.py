...
import inspect
from typing import Dict, Any, Type, TypeVar, Optional, Set, List, Callable, get_type_hints
...
class DependencyResolver:
    ...
    def analyze_dependencies(self, cls: Type[T]) -> List[DependencyInfo]:
        ...
        if hasattr(cls, '__init__'):
            constructor_deps = self._analyze_callable_dependencies(
                cls.__init__, DependencyType.CONSTRUCTOR
            )
    ...
    def get_missing_dependencies(
        self, cls: Type[T], available_types: Set[Type[Any]]
    ) -> List[DependencyInfo]:
        """
    ...
    def resolve_constructor_args(
        self, cls: Type[T], resolver_func: Callable[[Type[Any]], Any]
    ) -> Dict[str, Any]:
        """
