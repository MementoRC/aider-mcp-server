"""Application coordinator interface for high-level orchestration.

This module contains application coordination protocols that define the interface
for all coordination implementations at the organism level.

This was moved from interfaces/application_coordinator.py as part of the
