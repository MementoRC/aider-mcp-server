    ...
    async def get_resource_stats(self) -> Dict[str, Any]:
        ...
        async with self._lock:
            ...
            for resource in self._active_resources.values():
                ...
                resource_stats["resources_by_type"][resource_type] = (
                    resource_stats["resources_by_type"].get(resource_type, 0) + 1
                )
    ...
    async def _periodic_cleanup(self) -> None:
        ...
        while self._is_running:
            try:
                ...
                completed_tasks = [
                    resource_id for resource_id, task in self._cleanup_tasks.items()
                    if task.done()
                ]
