"""Dependency container interface for dependency injection coordination.

This module contains dependency injection protocols that define the interface
for all dependency container implementations at the organism level.

This was moved from interfaces/dependency_container.py as part of the
