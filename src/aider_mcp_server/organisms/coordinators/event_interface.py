"""Event coordinator interface for event orchestration.

This module contains event coordination protocols that define the interface
for all event coordination implementations at the organism level.

This was moved from interfaces/event_coordinator.py as part of the
...
from aider_mcp_server.molecules.events.interface import IEventHandler
